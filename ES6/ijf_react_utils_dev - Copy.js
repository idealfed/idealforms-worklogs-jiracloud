						  ...
						  <Card style={style}>
						    <CardHeader style={panelStyle}
						              avatar = {<Icon color="primary">{fieldStyle.avatar}</Icon>}
	 					              action={
							              <IconButton onClick={owningClass.handleClick}
								              aria-owns={owningClass.state.anchorEl ? 'simple-menu' : null}
          	 								  aria-haspopup="true">
							                <Icon>{fieldStyle.actionIcon}</Icon>
							              </IconButton>
							            }
							            title={<Typography variant="headline" component="h2">
													<DynamicHtml htmlContent={title} dataRow={lRow} />
							  					</Typography>}
							            subheader={<DynamicHtml htmlContent={subHeader} dataRow={lRow} />}
          					/>
							<CardContent>
								<DynamicHtml htmlContent={contentOut} dataRow={lRow} />
							</CardContent>
						  </Card>
					          ...
					          <Menu
						          ...
						          //THIS NEEDS TO BE A FUNCTION THAT DYNAMICALL CALLS
						          //SNIPPETS I THINK...
						            <MenuItem onClick={owningClass.handleClose}>Profile</MenuItem>
						            <MenuItem onClick={owningClass.handleClose}>My account</MenuItem>
						            <MenuItem onClick={owningClass.handleClose}>Logout</MenuItem>
        					  </Menu>
